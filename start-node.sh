...
novanetwork --datadir .dag --networkid "87" --rpc.allow-unprotected-txs --mine --miner.etherbase "0x000000000000000000000000000000000000dEaD" --nodiscover --graphql --maxpeers "1" --syncmode "snap" --ipcpath "connect"
