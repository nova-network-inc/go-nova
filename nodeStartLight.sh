...
novanetwork --datadir .dag --networkid "87" --config "novanetwork.toml" --nodiscover --maxpeers "1" --syncmode "light" --ipcdisable --miner.etherbase "0x000000000000000000000000000000000000dEaD"
