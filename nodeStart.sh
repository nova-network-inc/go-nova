...
novanetwork --datadir .dag --networkid "87" --config "novanetwork.toml" --nodiscover --maxpeers "1" --syncmode "snap" --ipcdisable --miner.etherbase "0x000000000000000000000000000000000000dEaD"
